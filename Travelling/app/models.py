...
class Contact(models.Model):
    ...
    driver_phono = models.CharField(max_length=12)
...
class Customer(models.Model):
    ...
    gender= models.CharField(max_length=20,choices=s)
    seatno=models.CharField(max_length=10)
    bus_name = models.CharField(max_length=100)
    no_tkt=models.IntegerField()
    mobile_number=models.CharField(max_length=15,null=True)
    source=models.CharField(max_length=20,default="Hyderabad")
    destination=models.CharField(max_length=20,default="Odisha")
...
class Passenger(models.Model): 
    ...
    User_id=models.ForeignKey(NewUser, on_delete=models.CASCADE,null=True)
    seatno=models.CharField(max_length=10) 
