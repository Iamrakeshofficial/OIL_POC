...
from .models import Route, Customer,Payment,Contact,Ticket_history,Destination,BusDetails,NewUser
...
class SignUpForm(UserCreationForm):
 ...
 class Meta:
  ...
  labels = {'email': 'Email','mobile_number':'Enter Your Mobile Number'}
  error_messages = {
...
class EditUserProfileForm(UserChangeForm):
  ...
  class Meta:
    model=NewUser
    fields=['username', 'first_name', 'last_name', 'email','start_date','last_login']
...
class CustomerForm(forms.ModelForm):
 class Meta:
  model = Customer
  fields = ['name', 'age','gender','no_tkt']
  labels = {'name': 'Enter Name', 'age': 'Enter Age','gender':'Enter Your Gender','bus_name':'Enter Bus Name','no_tkt':'Enter Ticket Number'}
